...
public class Constants {
    ...
    public static final String NOTIF_SLIDER_LEGACY_PANEL_KEY = "legacy_notification_slider";
    ...
    public static final int NOTIF_SLIDER_FEATURE_NONE = 0;
    public static final int NOTIF_SLIDER_FEATURE_LEGACY = 1;
    public static final int NOTIF_SLIDER_FEATURE_FULL = 2;
    ...
    public static final String[] sButtonPrefKeys = {
        BUTTON_SWAP_KEY,
        /* DEPRECATED */ NOTIF_SLIDER_TOP_KEY,
        /* DEPRECATED */ NOTIF_SLIDER_MIDDLE_KEY,
        /* DEPRECATED */ NOTIF_SLIDER_BOTTOM_KEY
    };
    ...
    public static int getNotificationSliderFeature() {
        if (FileUtils.fileExists(NOTIF_SLIDER_TOP_NODE) &&
                FileUtils.fileExists(NOTIF_SLIDER_MIDDLE_NODE) &&
                FileUtils.fileExists(NOTIF_SLIDER_BOTTOM_NODE)) {
            return NOTIF_SLIDER_FEATURE_LEGACY;
        } else if (FileUtils.fileExists(NOTIF_SLIDER_NODE)) {
            return NOTIF_SLIDER_FEATURE_FULL;
        } else {
            return NOTIF_SLIDER_FEATURE_NONE;
        }
    }
}
